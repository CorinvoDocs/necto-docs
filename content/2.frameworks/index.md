...
::cards
  ...
  <!--:::card{label="Django" color="#092E20" icon="simple-icons:django" color="#092E20" to="/docs/languages/django"}
  #description
  ...
  <!--:::card{label="Sinatra" icon="logos:sinatra" to="/docs/languages/sinatra"}
  #description
  Sinatra is a lightweight, flexible, and modular web framework for building fast and scalable web applications with Ruby.
  :::-->

  <!--:::card{label="Ember.js" icon="logos:ember-tomster" to="/docs/frameworks/ember"}
  #description
  Ember.js is a mature, scalable, and highly customizable JavaScript framework for building complex, interactive, and robust web applications.
  :::-->
::
