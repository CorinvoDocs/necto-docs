...
::cards
    ...
    #description
    Sorbet is a fast, incremental, and highly customizable static type checker for Ruby, providing real-time code analysis and type inference for improved code quality and reliability.
    :::
::
